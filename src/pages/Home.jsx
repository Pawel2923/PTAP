      ...
      <main>
        <section className={`section ${classes["index-banner"]}`}>
          <header>
            ...
            <p>
              ...
              które pozwolą Ci na bezpieczne lądowanie i startowanie. Poradniki
              dotyczące sprzętu jak i bardziej szczegółowe opisy są dostępne w
              sekcji Wiki.
            </p>
          </header>
        </section>
        <section className="section">
          ...
          <p>
            ...
            powietrza, łopaty wirnika głównego pobudzane są do ruchu co pozwala
            na opanowanie maszyny i bezpieczne posadzenie jej na ziemię.
          </p>
